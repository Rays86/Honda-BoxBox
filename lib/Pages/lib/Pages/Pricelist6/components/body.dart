...
class BelajarListView extends StatelessWidget {
  final List bulan = [
    ...
    'Penggantian Baterai : Rp.850,000',
    'Isi Ulang Baterai : Rp.25,000',
    'Penggantian Drive Belt : Rp.300,000',
    'Penggantian Timing Belt : -',
    'Penggantian Kampas Rem Depan : Rp.1,200,000',
    'Penggantian Kampas Rem Belakang : Rp.800,000',
    'Penggantian Piringan Rem Depan : Rp.700,000',
    ...
    'Ceramic Coating Mobil : Rp.4,000,000',
    ...
    'Penggantian Shock Suspensi Depan : Rp.3,700,000',
    'Penggantian Pegas Suspensi Depan : Rp.1,800,000',
    'Penggantian Shock Suspensi Belakang : Rp.3,400,000',
    'Penggantian Pegas Suspensi Belakang : Rp.1,400,000',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Daftar Harga Servis Honda Civic"),
      ),
