...
class BelajarListView extends StatelessWidget {
  final List bulan = [
    ...
    'Penggantian Shock Suspensi Depan : Rp.3,000,000',
    'Penggantian Pegas Suspensi Depan : Rp.1,500,000',
    'Penggantian Shock Suspensi Belakang : Rp.2,000,000',
    'Penggantian Pegas Suspensi Belakang : Rp.1,000,000',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text("Daftar Harga Servis Honda BRV"),
      ),
